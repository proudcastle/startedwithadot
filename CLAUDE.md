...
**Core Value:** The community decides what the game becomes — every feature of the dot is proposed, voted on, and implemented based on collective input. If the voting and proposal system doesn't work, nothing else matters.
